...
for (const light of [true,false]) {
 ...
 for(const [palette,color] of Object.entries({diemar:'#ffd400',naranja:'#f4791f',azul:'#3d8bfd',verde:'#22a06b',violeta:'#8b7bf7',rojo:'#e5484d',grafito:'#8a94a0'})){
...
console.log('PASS: seven palettes, explicit themes, system theme and CSS precedence');
