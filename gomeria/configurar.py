...
def revisar(url):
    ...
    if "[YOUR-PASSWORD]" in url or "[TU-PASSWORD]" in url:
        return ("Te quedó el texto [YOUR-PASSWORD] sin reemplazar. Cambialo por la "
                "contraseña que pusiste cuando creaste el proyecto, y borrá también "
                "los corchetes.")
    if ":6543" in url:
...
def main():
    ...
    try:
        url = input("Pegá la cadena acá y apretá Enter:\n> ").strip()
