...
- En un dual, adentro del naranja se prende de **verde** la goma elegida
  —interior o exterior— entera. Cuando el modelo trae las dos gomas en una
  sola pieza —los dos tractores vienen así— se pinta de verde la mitad que
  corresponde, que es la cubierta elegida. El mapa de posiciones de abajo
  usa los mismos dos colores: naranja las dos gomas de esa rueda, verde la
  que quedó elegida.
